...
//        let mockView = TakeMockPictureViewController()
//        let homeView = HomeMapViewController()
        let signUP = SignUpViewController()
        let loginController = LoginViewController()
        let navCont = UINavigationController(rootViewController: loginController)
        navCont.view.backgroundColor = UIColor.white
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "MockSpot")
